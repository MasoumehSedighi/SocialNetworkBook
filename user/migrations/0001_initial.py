    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_name', models.CharField(blank=True, max_length=130, null=True, verbose_name='last name')),
                ('username', models.CharField(max_length=50, null=True, verbose_name='username')),
                ('profile', models.TextField(max_length=150, verbose_name='description')),
                ...
                ('biography', models.CharField(max_length=100, null=True, verbose_name='biography')),
